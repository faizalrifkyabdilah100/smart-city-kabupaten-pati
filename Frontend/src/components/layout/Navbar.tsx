...
const Navbar: React.FC<Props> = ({ show, showLogout = true }) => {
  ...
  return (
    ...
    >
      <h1 className="text-white text-xl sm:text-2xl md:text-4xl lg:text-6xl font-light tracking-wide drop-shadow-lg text-center leading-tight">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {user ? (
            <>
              ...
              <div className="flex items-center gap-2">
                <div className="text-right hidden sm:block">
                  ...
                  <div className="text-[10px] sm:text-xs text-slate-300">{user.role?.toUpperCase() || '-'}</div>
                </div>
            ...
            <>
              ...
              <span className="text-xs sm:text-sm text-slate-300">Login</span>
            </>
          )}
        </div>
      </div>
