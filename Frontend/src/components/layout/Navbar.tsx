  ...
  return (
    ...
    >
      ...
      <div className="mt-3 sm:mt-4 md:mt-6 flex flex-wrap items-center justify-center gap-2 sm:gap-4">
        <div className="backdrop-blur-md bg-white/10 border border-white/20 hover:bg-white/20 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 md:py-2.5 rounded-full shadow-xl cursor-default">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {user ? (
            <>
              ...
              <div className="flex items-center gap-2">
                <div className="text-right hidden sm:block">
                  ...
                  <div className="text-[10px] sm:text-xs text-blue-200">{user.role?.toUpperCase() || '-'}</div>
                </div>
            ...
            <>
              ...
              <span className="text-xs sm:text-sm text-blue-100">Login</span>
            </>
          )}
        </div>
      </div>
