...
const GlobalBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full pointer-events-none z-0">
      ...
      {/* 0. BASE GRADIENT */}
      {/* Dark: navy. Light: biru gelap → biru medium — semua area cukup gelap untuk teks putih */}
      <div
        className="absolute inset-0 transition-all duration-700"
        style={{
          background: isDark
            ? 'linear-gradient(180deg, #0c1929 0%, #132744 30%, #1a2a4e 60%, #0f1f3d 100%)'
            : 'linear-gradient(160deg, #1e3a8a 0%, #1e40af 30%, #2563eb 60%, #3b82f6 100%)'
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          filter: isDark
            ...
            : "invert(1) grayscale(100%) brightness(1.8)",
      ...
      <div
        ...
        style={{
          background: isDark
            ...
            : 'radial-gradient(ellipse at 50% 30%, rgba(255,255,255,0.12) 0%, transparent 70%)'
        }}
      />
      ...
      <div
        ...
        style={{
          background: isDark
            ...
            : 'radial-gradient(ellipse at center, transparent 30%, rgba(30,58,138,0.35) 100%)'
        }}
      />

      {/* 3. LAYER PARTIKEL */}
      <div
        className={`absolute inset-0 transition-opacity duration-700 ${isDark ? 'opacity-60' : 'opacity-80'}`}
