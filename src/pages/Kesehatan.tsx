      ...
      <div className="w-full h-full flex flex-col justify-between">
        ...
        <div className="w-full p-8 flex justify-between items-start animate-slide-down">
            <div>
               ...
               <p className="text-blue-200 text-lg mt-2 font-light">Informasi RS, Puskesmas & Ketersediaan Kamar</p>
            </div>
        ...
        <div className="flex-1 flex items-center justify-center">
            <div className="text-white/50 text-xl font-light italic border-2 border-dashed border-rose-400/30 bg-rose-400/5 rounded-3xl p-10 backdrop-blur-sm">
